  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-gray-400">
      <div className="flex flex-col items-center">
        ...
        <p className="text-lg">Generate Stunning images based on your prompts!</p>
        <div className="w-full max-w-md">
          <input type="text" placeholder="Enter your prompt here..." className="w-full p-3 border-gray-300 rounded-lg mb-4"/>
